...
for line in file:
    ...
    if "[titulo]" in line:
        ...
        file_output.write("\n")
        file_output.write("document.add_heading('" + str(contador_apartado) + ". " + new_line + "', 1)\n")
        ...
        file_output.write("\n")
        file_output.write("document.add_heading('" + str(contador_apartado) + "." + str(contador_sub_apartado) + ". " + new_line + "', 2)\n")
        ...
        file_output.write("\n")
        file_output.write("document.add_heading('" + str(contador_apartado) + "." + str(contador_sub_apartado) + "." + str(contador_sub_sub_apartado) + ". " + new_line + "', 3)\n")
        ...
        file_output.write("\n")
        file_output.write("document.add_heading('" + str(contador_apartado) + "." + str(contador_sub_apartado) + "." + str(contador_sub_sub_apartado) + "." + str(contador_sub_sub_sub_apartado) + ". " + new_line + "', 4)\n")    
