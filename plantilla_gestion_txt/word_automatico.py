...
document.add_heading('1.1.6. Control de acceso al EDC', 3)

document.add_heading('1.1.6.1. Escenarios con EDC Simple', 4)
...
document.add_heading('1.1.6.2. Escenarios con dos o más EDCs', 4)
...
document.add_heading('1.1.7. Configuración TACACS+', 3)
...
document.add_heading('1.1.8. Configuración de NTP', 3)
...
document.add_heading('1.1.9. Configuración SNMP', 3)
...
document.add_heading('1.1.10. Activación de traps SNMP', 3)
document.add_paragraph('Cada servicio requerirá la activación de unas traps SNMP determinadas.')

document.add_heading('1.1.10.3. MacroLAN', 4)
...
document.add_heading('1.1.10.4. VPNIP', 4)
...
document.add_heading('1.1.10.5. DataInternet', 4)
...
document.add_heading('1.1.10.6. SiLAN e Ibercom IP Punto Central', 4)
document.add_paragraph('{% if servicio == "SILAN" or servicio == "Ibercom Punto Central" %}')
document.add_paragraph('    snmp-server enable traps')
document.add_paragraph('{% endif %}')

document.add_heading('1.1.10.7. Destino de los traps', 4)
...
document.add_heading('1.1.11. Configuración de RMON', 3)

document.add_heading('1.1.11.8. Servicios MacroLAN, VPNIP y DataInternet', 4)
document.add_paragraph('{% if servicio == "MacroLAN" or  servicio == "VPNIP" or servicio == "DataInternet" %}')
...
document.add_heading('1.1.11.9. SILAN', 4)
...
document.add_heading('1.1.11.10. Ibercom Punto Central', 4)
...
document.add_heading('1.1.12. Configuración de Syslog', 3)
